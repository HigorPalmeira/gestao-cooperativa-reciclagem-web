...
public class TransacaoCompraDAO {
	...
	public void inserirTransacaoCompra(TransacaoCompra transacaoCompra) throws SQLException {
	...
	public List<TransacaoCompra> listarTransacoesCompraPorLoteBruto(LoteBruto loteBrutoBuscado) throws SQLException {
	...
	public void buscarTransacaoCompraPorId(TransacaoCompra transacaoCompra) throws SQLException {
