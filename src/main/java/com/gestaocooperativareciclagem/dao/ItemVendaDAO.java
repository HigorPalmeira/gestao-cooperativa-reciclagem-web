...
public class ItemVendaDAO {
	...
	public List<ItemVenda> listarItensVenda() throws SQLException {
	...
	public List<ItemVenda> listarItensVendaPorVenda(Venda vendaBuscada) throws SQLException {
	...
	public List<ItemVenda> listarItensVendaPorTipoMaterial(TipoMaterial tipoMaterialBuscado) throws SQLException {
	...
	public void buscarItemVendaPorId(ItemVenda itemVenda) throws SQLException {
